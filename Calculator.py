...
frame = Frame(window)
frame.pack()
#__________________________________numbers__________________________________________________
...
#___________________________________symbols__________________________________________________
...
clears = Button(window, text="Clear", height=4, width=18, font=35, command=clear)
clears.pack()
